...
//     return (
//       <View className="flex-1 justify-center items-center py-8">
//         <Text className="text-red-600 text-base text-center">Error: {error}</Text>
//       </View>
//     );
//   }
...
//         className="flex-1"
//       >
//         <View className="min-w-[350px]">
//           {/* Header */}
//           <View className="flex-row bg-green-500 rounded-t-lg">
//             <View className="flex-1 py-3 px-4 items-center justify-center min-w-[80px]">
...
//                 <Text className="text-md text-gray-900 text-center">
//                   {row.period}
//                 </Text>
//               </View>
//               <View className="flex-1 py-2 px-4 items-center justify-center min-w-[80px]">
...
//                     <View
//                       key={i}
//                       className={`w-4 h-4 rounded-full border border-white ${getColorDotClass(color)}`}
//                     />
//                   ))}
//                 </View>
//               </View>
